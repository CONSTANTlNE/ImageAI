...
return [
    ...
    'custom' => [
        'imageUrl' => [
            'required_without_all' => 'გთხოვთ ატვირთოთ ფოტო ან აირჩიოთ არსებულიდან',
            'regex'=>'ლინკი არასწორია'
        ],
        'runwayUpload' => [
            'required_without_all' => 'გთხოვთ ატვირთოთ ფოტო ან აირჩიოთ არსებულიდან',
        ],
        'code' => [
            'required' => 'შეიყვანეთ სმს კოდი',
        ],
        'ratio' => [
            'in' => 'არასწორი ფორმატი, აირჩიეთ  16:9 / 9:16 / 4:3 / 3:4 ან HD',
            'required' => 'მიუთითეთ ფორმატი',
        ],
        'prompt' => [
            'required' => 'მიუთითეთ ფოტოს აღწერა',
        ],
        'page' => [
            'numeric' => 'გვერდი უნდა იყოს რიცხვითი მნიშვნელობა',
        ],
        'perpage' => [
            'numeric' => 'ჩანაწერის რაოდენობა უნდა იყოს რიცხვითი მნიშვნელობა',
        ],
    ],
    ...
    'attributes'           => [
        ...
        'prompt'=> 'ფოტოს აღწერა',
        'ratio'=> 'ფორმატი',
        'runwayUpload' => 'ატვირთული ფოტო',
        'imageUrl'=> 'გალერეადან არჩეული ფოტო',
        'address'                  => 'მისამართი',
