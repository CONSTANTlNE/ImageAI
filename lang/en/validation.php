...
return [
    ...
    'custom' => [
        'imageUrl' => [
            'required_without_all' => 'Please choose from gallery or upload a new image.',
            'url'=>'Chosen image is invalid',
            'regex'=>'Chosen image is not from local.ews.ge',
        ],
        ...
        'ratio'=>[
            'in' => 'Ratio must be either 16:9 or 6:16',
        ]
    ],

    'attributes'           => [
        'runwayUpload' => 'Uploaded file',
        'imageUrl'=> 'Image from gallery',
        'address'                  => 'address',
