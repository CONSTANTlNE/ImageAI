                    ...
                    <form action="{{route('login')}}" method="post">
                        ...
                        <div class="grid grid-cols-12">
                            ...
                            <div class="xl:col-span-12 col-span-12 grid">
                                <button
                                   class="ti-btn ti-btn-lg bg-primary text-white !font-medium dark:border-defaultborder/10">Sign
                                    In</button>
                            </div>
                        </div>
                    </form>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="text-white text-center p-[3rem] flex items-center justify-center">
                                <div>
                                    <div class="mb-[3rem]">
                                        <img src="../assets/images/authentication/2.png" class="authentication-image"
                                             alt="">
                                    </div>
                                    <h6 class="font-semibold text-[1rem]">Sign In</h6>
                                    <p class="font-normal text-[0.875rem] opacity-[0.7]"> Lorem ipsum dolor sit amet,
                                        consectetur
                        ...
                        <div class="swiper-slide">
                            <div class="text-white text-center p-[3rem] flex items-center justify-center">
                                <div>
                                    <div class="mb-[3rem]">
                                        <img src="../assets/images/authentication/3.png" class="authentication-image"
                                             alt="">
                                    </div>
                                    <h6 class="font-semibold text-[1rem]">Sign In</h6>
                                    <p class="font-normal text-[0.875rem] opacity-[0.7]"> Lorem ipsum dolor sit amet,
