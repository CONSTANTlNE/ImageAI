                        ...
                        <div class="text-center flex-col justify-center gap-2 w-full px-3 ">
                            <form style="max-width: 100px" class="mb-2 w"
                                ...
                                <select
                                    ...
                                    <option @selected(request()->query('model') === 'colorization') value="colorization">
                                        Colorize
                                    </option>
                                                            ...
                                                            @if($transaction->model==='flux')
                                                                @if($transaction->flux)
                                                                    <div class="flex justify-center">
                                                                        ...
                                                                        @else
                                                                            <div class="flex justify-center">
                                                                                <p>{{__('Image Was Deleted By User')}}</p>
                                                                            </div>
                                                                    </div>
                                                                @endif
                                                            @endif
                                                            @if($transaction->model==='colorization')
                                                                @if($transaction->colorize)
                                                                    <div class="flex justify-center">
                                                                        @foreach($transaction->colorize->media as $media)
                                                                            <a
                                                                                    href="{{$media->getUrl()}}"
                                                                                    class="glightbox box responcive-image-history"
                                                                                    data-gallery="gallery1">
