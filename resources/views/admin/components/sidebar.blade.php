            ...
            <ul class="main-menu">
                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        ...
                        <span class="side-menu__label">ლოკალიზაცია</span>
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide">
                            <a href="{{route('testPage')}}" class="side-menu__item">სატესტო გვერდი</a>
                        </li>
                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        <i class="bx bx-file-blank side-menu__icon"></i>
                        <span class="side-menu__label">Stuff</span>
                        <i class="fe fe-chevron-right side-menu__angle"></i>
                    </a>
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide">
                            <a href="" class="side-menu__item">email queue</a>
                        </li>
