                ...
                <div class="header-element py-[1rem] md:px-[0.65rem] px-2 header-country hs-dropdown ti-dropdown hidden sm:block [--placement:bottom-left]">
                    <button  id="dropdown-flag" type="button"
                        ...
                        @foreach($locales as $locale)
                            @if($locale['abbr']===request()->segment(1))
                                ...
                                @foreach($locales as $locale)
                                    ...
                                    <div class="ti-dropdown-item !p-[0.65rem]">
                                        ...
                                        <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                                            ...
                                            <div>
                                                <p class="!text-[0.8125rem] font-medium">{{$locale['language']}}</p>
                                            </div>
                                        </div>
                                        </a>
                                    </div>
...
{{--                                    />--}}
                              ...
                              <span
                                      class="text-black mb-1 dark:text-white !font-medium"
                              >$1,299.00</span
                              >
                                                <a
                                                        aria-label="anchor"
                                        ...
                                        <div
                                                class="min-w-fit flex items-start justify-between"
                                        >
                                            <ul
                                                    class="header-product-item dark:text-white/50 flex"
                                            >
                                                <li>Metallic Blue</li>
                                                <li>6gb Ram</li>
                                            </ul>
...
{{--                                    />--}}
                                    <div class="grow">
                                        <div class="flex items-start justify-between mb-0">
                                            ...
                                            <div class="inline-flex">
                              <span
                                      class="text-black dark:text-white !font-medium mb-1"
                              >$179.29</span
                              >
                                                <a
                                                        aria-label="anchor"
...
{{--                                    />--}}
                                    <div class="grow">
                                        <div class="flex items-start justify-between mb-0">
                                            ...
                                            <div class="inline-flex">
                              <span
                                      class="text-black !font-medium mb-1 dark:text-white"
                              >$29.00</span
                              >
                                                <a
                                                        aria-label="anchor"
...
{{--                                    />--}}
                      ...
                      >
                        <i class="ri-shopping-cart-2-line text-[2rem]"></i>
                                ...
                                <span
                                        class="mb-3 !font-normal text-[0.8125rem] block text-defaulttextcolor dark:text-[#8c9097] dark:text-white/50"
                ...
                >
                    ...
                    >
                        <i
                                class="bx bx-grid-alt header-link-icon text-[1.125rem]"
                        ></i>
                    </button>
...
{{--                                        />--}}
                ...
                <!-- Fullscreen -->
                <div
                        class="header-element header-fullscreen py-[1rem] md:px-[0.65rem] px-2"
                >
                    <!-- Start::header-link -->
                    <a
                            aria-label="anchor"
                    ...
                    >
                        ...
                        ></i>
                        <i
                                class="bx bx-exit-fullscreen full-screen-close header-link-icon hidden"
                        ></i>
                    </a>
                    <!-- End::header-link -->
                </div>
                ...
                >
                    ...
                    <div class="md:block hidden dropdown-profile">
                        ...
                        <span
                                class="opacity-[0.7] font-normal text-[#536485] block text-[0.6875rem]"
                        >Web Designer</span
                        >
                    </div>
                    <div
                    ...
                    >
                        ...
                        >
                            ...
                            <li>
                                ...
                                ><i
                                            class="ti ti-adjustments-horizontal text-[1.125rem] me-2 opacity-[0.7]"
                                    ></i
                                    >Settings</a
                                >
                            </li>
                            <li>
                                <a
                                        ...
                                        href="javascript:void(0);"
                                ><i
                                            class="ti ti-wallet text-[1.125rem] me-2 opacity-[0.7]"
                                    ></i
                                    >Bal: $7,12,950</a
                                >
                            </li>
                            <li>
                                <a
                                        ...
                                        href="chat.html"
                                ><i
                                            class="ti ti-headset text-[1.125rem] me-2 opacity-[0.7]"
                                    ></i
                                    >Support</a
                                >
                            </li>
