    ...
    <div class="section-space-sm-bottom">
        <div class="container">
            <div class="row justify-content-center">
                    ...
                    <div class="downloadBtnsContainer" >
                        <button  id="install-button" class="downloadbtn" type="button">
                            <span style="margin-right: 10px;" class="text-gradient-primary">ჩამოტვირთე</span>
                        ...
                        <button class="downloadbtn" type="button">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="40" height="40"
                                 viewBox="0 0 814 1000"><path fill="#fff"
